 ...
 */
public interface IZposedHookInitPackageResources extends IZposedMod {
    /**
    ...
    final class Wrapper extends XC_InitPackageResources {
        private final IZposedHookInitPackageResources instance;
        public Wrapper(IZposedHookInitPackageResources instance) {
