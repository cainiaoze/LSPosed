...
public class StartBootstrapServicesHooker implements XposedInterface.Hooker {
    ...
    public static void beforeHookedMethod() {
        ...
        try {
            ZposedInit.loadedPackagesInProcess.add("android");

            XC_LoadPackage.LoadPackageParam lpparam = new XC_LoadPackage.LoadPackageParam(ZposedBridge.sLoadedPackageCallbacks);
